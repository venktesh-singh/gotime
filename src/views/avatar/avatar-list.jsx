...
const Avatar = () => {
  ...
  //console.log("Sia Avatar Data", dataList.data);    
    fetch('https://gotimeapi.onrender.com/api/avatar')  
    .then(response => {
      if (!response.ok) {  
            ...
            <StyledTable>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="center" sx={{ fontWeight: 'bold' }}>Avatar Pic</TableCell>
                ...
                {dataList?.data?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((subscriber, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell align="center">
                      ...
                      <Link sx={{ m: 0.5 }} variant="contained" to={{ pathname: "/avatar/avatar-detail", state: { subscriber }}} name="User Details" >
                        <PreviewIcon
                      ...
                      <Link sx={{ m: 0.5 }} variant="contained" to={{ pathname: "/avatar/avatar-edit", state: { subscriber }}} name="User Edit">
                        <EditIcon
                          aria-label="EditIcon"
                          aria-haspopup="true"
                        >
